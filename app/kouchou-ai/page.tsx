    ...
    <div>
      <section className="mx-auto max-w-xl mt-10">
        ...
        <section>
          ...
          <p className="mt-4">
            日本では、2023年夏の都知事選において安野たかひろのチームがTalk to the Cityを活用し、X（旧Twitter）上の都知事選に関する発言を集約・可視化する試みが行われました。同年12月には、日本テレビの衆院選報道でAIによる意見分析が実施され、2024年2月には「シン東京2050」プロジェクトでも使用されました。
          </p>
          <p className="mt-4">
