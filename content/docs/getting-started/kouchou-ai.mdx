---
title: 広聴AI導入の仕方
description: 広聴AI導入の仕方を解説したページです。
---

# 広聴 AI / kouchou-ai

デジタル民主主義 2030 プロジェクトにおいて、ブロードリスニングを実現するためのソフトウェア「広聴 AI」のドキュメントです。
...
[GitHub レポジトリはこちら](https://github.com/digitaldemocracy2030/kouchou-ai)
